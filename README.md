...
- **외부 상업화/출판 패키징:** 보류
- 책 프로젝트를 다시 시작할 때는 먼저 `docs/internal-development-brief.md`를 읽으면 됩니다.

기존 `marketing/`의 publisher packet 관련 문서는 삭제하지 않고 유지하지만, 현재는 **즉시 외부 제출용이 아니라 미래 상업화 재개용 템플릿/참고 자료**로 봐야 합니다.
